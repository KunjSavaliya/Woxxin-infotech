...
export default function GlobalPartners() {
  return (
    <div className="max-w-[90rem] mx-auto pt-24 pb-16 p-2 mt-[-3px] ">
      <Text className="text-4xl md:text-2xl lg:text-3xl xl:text-[55px] text-white font-semibold">
        Global Partners
      </Text>
          ...
          {logos.map((src, index) => (
            <SwiperSlide key={index}>
              <div className="flex items-center justify-center">
                <img src={src} alt="" className="object-contain h-20 w-28" />
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
