...
achievements."
        ...
        <div className=" mt-[-4px]">
          <ScrollAnimation animateIn="animate__animated animate__fadeInUp">
            <div className="flex flex-col justify-between gap-10 px-5 pt-24 p-16 md:flex-row max-w-7xl mx-auto">
          ...
          <ScrollAnimation animateIn="animate__animated animate__fadeInUp">
            <div className="flex flex-col gap-5 pt-5 sm:pt-24 md:flex-row justify-betweensm:px-12 max-w-7xl mx-auto p-16">
        ...
        <div className="relative w-full h-full pb-28">
          ...
          />
          <div className="relative z-10 flex flex-col gap-16 p-16 max-w-7xl mx-automt-[-1px]">
